...
A classe Produto é composta pelos atributos nome, descrição, tipo e preco, e por seus getter e setters. 

Também é nessa classe que está a enum com os tipos de produtos. 
