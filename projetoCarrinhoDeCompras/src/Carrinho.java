...
public class Carrinho implements Printavel {
	...
	@Override
	public void printa() {
		System.out.println("Prezado(a) cliente " + cliente.getNome() + ", esse � o seu carrinho: \n");
	...
	public Carrinho adicionarItem(Produto produto, int quantidade) {
		...
		if (quantidade <= 0) {
			System.out.println("Erro ao adicionar item. Quantidade inv�lida. \n");
			return this;
		}
	...
	public Carrinho removerItem(Produto produto) {
		...
		if (this.produtos.contains(produto)) {
			...
			System.out.println(
					"Erro ao remover item. O produto " + produto.getDescricao() + " n�o consta no carrinho. \n");
		}
		return this;
	}
	...
	public Carrinho modificarQuantidadeItem(Produto produto, int novaQuantidade) {
		...
		if (novaQuantidade <= 0) {
			System.out.println("Erro ao modificar item. Quantidade inv�lida. Use a fun��o Remover Item. \n");
			return this;
		}
		if (this.produtos.contains(produto)) {
			int indice = this.produtos.indexOf(produto);
			...
			System.out.println(
					"Erro ao modificar item. O produto " + produto.getDescricao() + " n�o consta no carrinho. \n");
		}
		return this;
	}
	...
	public Carrinho adicionarModificador(ModificadorPreco mod) {
		...
		if (!this.modificadores.contains(mod)) {
			...
			System.out.println(mod.getDescricao() + " j� foi aplicado no carrinho. \n");
		}
		return this;
	}
