...
public class TestaCarrinho {
	...
	public static void main(String[] args) {
		...
		Produto detergente = new Produto("Detergente", "Detergente IP� LIM�O", ProdutoTipo.PRODUTO_LIMPEZA, 5);
		...
		ModificadorPreco promocaoTec = new ModificadorPreco("Promo��oTEC", "Promo��o para a Era da Tecnologia",
		...
		ModificadorPreco frete = new ModificadorPreco("Frete", "Frente s� de roupa",
